    ...
    const fetchData = async () => {
      try {
        const response = await axios.get(
          "https://api.sadaivsatya.com/api/home/kamKiBat"
        );
        ...
        >
          ...
          <div className="ak-block-inner clearfix border">
            <div className="ak-block-posts clearfix">
              {posts.kamKiBat.slice(0, 5).map((newsItem) => {
                ...
                return (
                  <article
                    ...
                    className="ak-module bordergap ak-module-1-small ak-column-module clearfix post-249 post type-post status-publish format-standard has-post-thumbnail  category-business category-entertainment category-featured category-us-news category-work-life tag-breaking tag-election tag-politics tag-technology tag-world-news"
                  >
