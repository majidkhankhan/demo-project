    ...
    const fetchData = async () => {
      try {
        const response = await axios.get(
          "https://api.sadaivsatya.com/api/home/photoGallery"
        );
              ...
              >
                ...
                <div className="wdgt-wrap" id="r_main_gallery_24">
                  <div className="wdgt-lft">
                    {postData.photoGallery.slice(0, 1).map((post) => (
                      <div key={post.mainKhabarId}>
                        ...
                        >
                          ...
                          <img
                            ...
                            loading="lazy"
                            src={`${image_resize}?url=${BASE_URL}${post.newsImage}&w=471&h=265&outtype=webp`}
                            width="466px"
                            height="262px"
                            srcSet={`${image_resize}?url=${BASE_URL}${post.newsImage}&w=471&h=265&outtype=webp`}
                    ...
                    {postData.photoGallery.slice(1, 2).map((post) => {
                  ...
                  <div className="wdgt-rgt">
                    {postData.photoGallery.slice(2, 6).map((post) => {
                      const shareLinks = generateShareLinks(
                        post.mainKhabarId,
                        post.newsHeading
                      );
