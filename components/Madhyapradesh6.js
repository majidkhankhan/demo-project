    ...
    <div>
      <div className="ak-block-header ak-block-header-style-5 no-tabs">
        ...
        >
          <div className="wdgt-hdng">
            <h1 className="head">
              <Link href="/" title=" खबरें और पढ़ें" aria-label="खबरें और पढ़ें">
                खबरें और पढ़ें
              </Link>
            </h1>
          </div>
      ...
      <div className="wdgt-wrap" id="common-lifestyle">
        <div className="wdgt-lft">
          {postData.frontKhabars.slice(0, 4).map((post) => {
        ...
        <div className="wdgt-rgt">
          {postData.frontKhabars.slice(4, 8).map((post) => {
            const shareLinks = generateShareLinks(
              post.mainKhabarId,
              post.newsHeading
            );
