                    ...
                    <div className="ak-block-posts clearfix">
                      <div className="row">
                        ...
                        <div className="col-sm-6">
                          {posts.mpNews.slice(2, 3).map((newsItem) => (
                            <article key={newsItem.id} className="ak-module ak-module-6 clearfix post-239 post type-post status-publish format-standard has-post-thumbnail  category-business category-entertainment category-tech-science tag-breaking tag-election tag-politics tag-technology tag-world-news">
                              {newsItem.newsImage.endsWith(".mp4") && (
                        ...
                        <div className="col-sm-3">
                          {posts.mpNews.slice(3, 4).map((newsItem) => (
                          ...
                          {posts.mpNews.slice(4, 5).map((newsItem) => (
