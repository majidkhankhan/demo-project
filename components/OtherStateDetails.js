...
import OtherStateJob from "./OtherStateJob";
import SocialMediaShare from "./SocialMediaShare";
import OtherStatejarur from "./OtherStatejarur";
import OtherStateLife from "./OtherStateLife";
import OtherStateCareer from "./OtherStateCareer";
import OtherStateFake from "./OtherStateFake";
              ...
              <div className="ak-content" style={{ transform: "none" }}>
                <div className="containercustome" style={{ transform: "none" }}>
                  ...
                  <div className="row" style={{ transform: "none" }}>
                    ...
                    <div className="ak_column_2 col-md-6 ">
                      ...
                      <div className="ak-article-inner">
                        <div className="ak-article-inner">
                          ...
                          {formatDateInHindi(newsDetails.mainTazaKhabars.date)}
...
export default OtherStateDetails;
