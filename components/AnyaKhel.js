            ...
            <div className="ak_vc_wrapper wpb_wrapper">
              ...
              >
                <div className="wdgt-hdng">
                  <h1>
                    <Link href="/Khels" title="अन्य खेल" aria-label="अन्य खेल">
                      अन्य खेल
                    </Link>
                  </h1>
                </div>
                <div className="wdgt-wrap" id="r_main_gallery_24">
                  <div className="wdgt-lft">
                    {posts.khelKhabars.slice(0, 1).map((newsItem) => (
                      <div
                    ...
                    {posts.khelKhabars.slice(1, 2).map((newsItem) => {
                  ...
                  <div className="wdgt-rgt">
                    {posts.khelKhabars.slice(2, 6).map((newsItem) => {
                      const shareLinks = generateShareLinks(
                        newsItem.mainKhabarId,
                        newsItem.newsHeading
                      );
