...
const DainickRashifalRileted = () => {
  ...
  const generateShareLinks = (mainKhabarId, newsHeading) => {
    ...
    const url = `${window.location.origin}/DainikRashifalDetails/${mainKhabarId}`;
    return {
              ...
              >
                <div className="ak-block-inner clearfix">
                  <div className="ak-block-posts clearfix">
                    {postData.dharam.slice(7, 15).map((post) => {
...
export default DainickRashifalRileted;
