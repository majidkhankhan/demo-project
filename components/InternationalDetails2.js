...
function InternationalDetails2() {
        ...
        >
          <div className="ak-block-header ak-block-header-style-5 no-tabs mt-2">
            ...
            >
              <div className="wdgt-hdng">
                <h1 className="head">
                  <Link href="/" title=" खबरें और भी" aria-label=" खबरें और भी">
                    खबरें और भी हैं...
                  </Link>
                </h1>
              </div>
          ...
          <div className="ak-block-inner clearfix">
            <div className="ak-block-posts clearfix">
              {posts.international.slice(0, 5).map((newsItem) => {
...
export default InternationalDetails2;
