...
import MadhyapradeshDetails1 from "./MadhyapradeshDetails1";
import MadhyapradeshDetails2 from "./MadhyapradeshDetails2";
import MadhyapradeshDetails3 from "./MadhyapradeshDetails3";
...
function MadhyapradeshDetailsD() {
              ...
              <div className="containercustome" style={{ transform: "none" }}>
                ...
                >
                  ...
                  >
                    ...
                    >
                      <div className="sidebar post-sidebar">
                        <MadhyapradeshDetails2 />

                        <div className="mt-2">
                          <MadhyapradeshDetails3 />
                        </div>
                      </div>
                      <div
                        className="resize-sensor"
...
export default MadhyapradeshDetailsD;
