        ...
        >
            ...
            >
              <div className="wdgt-hdng">
                <h1 className="head">
                  <Link
                    href="/"
                    title="शेयर बाज़ार खबरें"
                    aria-label="शेयर बाज़ार खबरें"
                  >
                    शेयर बाज़ार खबरें
                  </Link>
                </h1>
          ...
          <div className="ak-block-inner clearfix">
            <div className="ak-block-posts clearfix">
              {postData.stockMarket.slice(0, 5).map((post) => {
...
export default InterNantionalShare;
