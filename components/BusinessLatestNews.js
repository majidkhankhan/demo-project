    ...
    const fetchData = async () => {
      try {
        const response = await axios.get(
          "https://api.sadaivsatya.com/api/home/bussinessRandom"
        );
      ...
      >
        ...
        <div className="ak-block-inner clearfix">
          <div className="ak-block-posts clearfix">
            {postData.bussinessRandom.slice(0, 5).map((post) => {
...
export default BusinessLatestNews;
