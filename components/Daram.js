      ...
      <div className="container">
        <div className="ak-block-header ak-block-header-style-5 no-tabs">
          ...
          >
            <div className="wdgt-hdng">
              ...
              <Link href="/astrology/" className="pull-right rdmr">
                {" "}
        ...
        <div className="wdgt-wrap" id="common-lifestyle">
          <div className="wdgt-lft">
            {posts.dharam.slice(0, 1).map((newsItem) => (
              <Link
                href="#"
            ...
            {posts.dharam.slice(1, 3).map((newsItem) => (
              <Link
                href="#"
          ...
          <div className="wdgt-rgt">
            {posts.dharam.slice(3, 7).map((newsItem) => (
              <Link
                href="#"
