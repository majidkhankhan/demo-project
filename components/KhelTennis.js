    ...
    const fetchData = async () => {
      try {
        const response = await axios.get(
          "https://api.sadaivsatya.com/api/home/tennis"
        );
      ...
      >
        <div className="ak-block-header ak-block-header-style-5 no-tabs">
          ...
          >
            <div className="wdgt-hdng">
              <h1 className="head">
                <Link href="/Khels" title="धर्म" aria-label="टेनिस खेल">
                  टेनिस खेल
                </Link>
              </h1>
            </div>
        ...
        <div className="ak-block-inner clearfix">
          <div className="ak-block-posts clearfix">
            {posts.tennis.slice(0, 5).map((newsItem) => {
